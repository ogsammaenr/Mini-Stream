...
Sarki* csv_yukle(const char* dosya_yolu, int limit, int* toplam) {
    ...
    char satir[2048];
    fgets(satir, sizeof(satir), f); // Başlık satırını atla 
    ...
    *toplam = 0;
    ...
    while (fgets(satir, sizeof(satir), f) && *toplam < limit) {
        ...
        // Verileri kolon indekslerine göre çek 
        ...
        // ministream.c'deki fonksiyonu çağırarak heap'te oluştur 
